...
<head>
    ...
    <!--css-->
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/css/page-sobre.css">
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-md-12 titulo banner-content">                            
                            <div class="imgarea">
                                <img src="<?php echo get_stylesheet_directory_uri(); ?>/assets/item-banner/QUEM_SOMOS.svg" alt="">
                            </div>
                            <h1>fale conosco</h1>
